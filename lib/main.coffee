...
module.exports =
  config:
    ...
    typingConfirmsSelection:
      ...
      description: 'If enabled, typing a key that doesn\'t match any binding will confirm your selection in case you made any. If disabled, you\'ll just continue typing.'
      type: 'boolean'
      default: false
      order: 14
